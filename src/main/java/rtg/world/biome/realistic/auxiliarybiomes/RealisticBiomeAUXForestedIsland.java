package rtg.world.biome.realistic.auxiliarybiomes;
...
public class RealisticBiomeAUXForestedIsland extends RealisticBiomeAUXBase {

    public RealisticBiomeAUXForestedIsland(Biome biome) {
    ...
    public SurfaceBase initSurface() {
        ...
        return new SurfaceVanillaExtremeHills(getConfig(), baseBiome().topBlock, baseBiome().fillerBlock, baseBiome().topBlock, baseBiome().fillerBlock, 60f, -0.14f, 14f, 0.25f);
    }
