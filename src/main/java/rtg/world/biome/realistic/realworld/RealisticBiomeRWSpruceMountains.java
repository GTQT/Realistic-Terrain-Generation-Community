...
public class RealisticBiomeRWSpruceMountains extends RealisticBiomeRWBase {

    public RealisticBiomeRWSpruceMountains(Biome biome) {
    ...
    public SurfaceBase initSurface() {
        ...
        return new SurfaceRWSpruceMountains(getConfig(), this.baseBiome().topBlock, this.baseBiome().fillerBlock, Blocks.GRASS.getDefaultState(), Blocks.DIRT.getDefaultState(), 60f, -0.14f, 14f, 0.25f);
    }
